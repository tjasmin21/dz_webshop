...
$lang = array_merge ( $lang, array (
		...
		"TOOLTIP_SC1" => "Please select a video from the list",
		"TOOLTIP_SC2" => "Please select a video from the list",
		"TOOLTIP_SC3" => "Please select a video from the list",
		"TOOLTIP_SC4" => "Please select a video from the list",
		"TOOLTIP_SC5" => "Please select a video from the list",
		"TOOLTIP_SC6" => "Please select a video from the list",
		"TOOLTIP_SC7" => "Please select a video from the list" 
) );
...
$lang = array_merge ( $lang, array (
		...
		"NEW_REGIST_FILE" => "new-registration_en.txt",
		"RESEND_ACTIV_FILE" => "resend-activation_en.txt",
