                            ...
                            <div class='form-group'>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="radio" name="shipMethod"
                                           value="Express shipping"><?php echo lang("SHIP_METHOD_EXPRESS") ?><br>
                                    <input type="radio" name="shipMethod"
                            ...
                            <div class='form-group'>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input style="float:right;" value="<?php echo lang("CHECKOUT") ?>" type="submit"
                                               id="final_checkout" name="final_checkout" class="btn btn-primary btn-lg">
                                    </div>
                                </div>
                            </div>
                        </form>
